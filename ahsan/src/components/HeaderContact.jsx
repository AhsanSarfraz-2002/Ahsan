  ...
  return (
    <div className="relative h-[450px] border border-black overflow-hidden">
      ...
      <div className="text-center text-white mt-40 z-10 relative">
        <h1 className="text-6xl font-semibold hover:text-red-500 transition duration-300">Contact</h1>
        <p className="mt-2 text-md text-gray-300">
          <a className="font-semibold text-white text-lg" href="#">Home&gt;</a> Contact
        </p>
      </div>
    </div>
  );
